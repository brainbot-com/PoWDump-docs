...
Your locked ETH is stuck there, you're watching your friends make millions by dumping, but you
can't take part on the action. Don't lose hope though! There is a way to move the ethW in your
Gnosis Safe to an Externally Owned Account (EOA) on EthereumPoW, which then enables you to use PoWDump.

:::note
This tutorial makes use of the ETHW gnosis recovery app. We are not affiliated with the ETHW gnosis recovery app in any
way.
Always make sure you know what you're doing, that replay protection is in place on the chain you're interacting with and generally use at your own risk.
:::

1. First create an EOA that you have the private key to.
