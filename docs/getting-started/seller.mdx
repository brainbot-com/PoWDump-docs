...
If your swap offer has expired the app will not show you the swap. You can still get your funds back by
submitting a `refund transaction` directly on the contract.